...
def perform_browser_action(text):
    if "open new tab" in text or "new tab kholo" in text:
        ...
        refresh_page()
    elif "switch to next tab" in text or "next tab pe jao" in text:
        switch_to_next_tab()
    elif "switch to previous tab" in text or "previous tab pe jao" in text:
        switch_to_previous_tab()
    elif "open history" in text or "history kholo" in text:
        open_history()
    elif "open bookmarks" in text or "bookmarks kholo" in text:
        open_bookmarks()
    elif "go back" in text or "pichle page pe jao" in text:
        go_back()
    elif "go forward" in text or "aage ke page pe jao" in text:
        go_forward()
